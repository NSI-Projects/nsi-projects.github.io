...
## Projets disponibles actuellement

| Projet | Description |
|--------|------------|
| [Le Bi-Vertisseur](bivertisseur/) | Convertit des nombres écrits dans une base comprise entre 2 et 36 dans une autre base, avec support des nombres relatifs. |
| [Le Monnayeur](monnayeur/) | Calcule la répartition de billets et pièces pour un montant donné, en prenant le billet ou la pièce avec le montant le plus élevé possible. |
| [Le jeu du Skyscrapers](skyscrapers/) | Crée des grilles de taille 1X1 à 10X10 pour le jeu du Skyscrapers, avec indices, et permet de cacher ou afficher la solution. |

---

## Comment utiliser

1. Accéder au site grâce au lien : https://nsi-projects.github.io
